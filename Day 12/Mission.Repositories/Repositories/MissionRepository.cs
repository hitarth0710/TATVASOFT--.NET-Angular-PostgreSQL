...
namespace Mission.Repositories.Repositories
{
    public class MissionRepository(MissionDbContext dbContext) : IMissionRepository
    {
        ...
        public async Task<bool> AddMission(Missions model)
        {
            try
            {
                var isExist = _dbContext.Missions.Where(x =>
                ...
                await _dbContext.Missions.AddAsync(missions);
        ...
        {
            return await _dbContext.MissionApplications.Where(x => !x.IsDeleted).ToListAsync();
        }
